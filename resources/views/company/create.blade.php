                    ...
                    <section>
                        ...
                        <form method="post" action="{{route('company.store')}}" class="mt-6 space-y-6" enctype="multipart/form-data">
                            ...
                            <div>
                                ...
                                <x-text-input id="website" name="website" type="text" class="mt-1 block w-full" :value="old('website')" required autocomplete="website" />
                                <x-input-error class="mt-2" :messages="$errors->get('website')" />

                            </div>
                            <div>
                                <x-input-label for="email" :value="__('Revenue')" />
                                <x-text-input id="revenue" name="revenue" type="text" class="mt-1 block w-full" :value="old('revenue')" required autocomplete="revenue" />
